		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if err != nil {
				...
				case vestingStart != 0 && vestingEnd != 0:
					genAccount, err = authvesting.NewContinuousVestingAccount(baseAccount, vestingAmt.Sort(), vestingStart, vestingEnd)
				if err != nil {
					return fmt.Errorf("failed to create continuous vesting account: %w", err)
				}

				case vestingEnd != 0:
					genAccount, err = authvesting.NewDelayedVestingAccount(baseAccount, vestingAmt.Sort(), vestingEnd)
					if err != nil {
